...
def calculate_frequencies(file_contents):
    ...
    uninteresting_words = ["the", "a", "to", "if", "is", "it", "of", "and", "or", "an", "as", "i", "me", "my", "we",
                           ...
                           "some", "such", "no", "nor", "too", "very", "can", "will", "just", "on", "in"]
    ...
    for word in file_list:
        ...
        count_word = ""
        for letter in word:
            if letter.isalpha() and ~letter.isspace():
                count_word += letter
            else:
                continue
        if count_word not in words_count and count_word not in uninteresting_words:
            words_count[count_word] = 0
        if count_word not in uninteresting_words:
            words_count[count_word] += 1
    #     wordcloud
