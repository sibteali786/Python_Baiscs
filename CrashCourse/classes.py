...
def exchange_ideas(you, me):
    ...
    sum = 0
    sum = you.ideas
    you.ideas = me.ideas + sum
    me.ideas = me.ideas + sum
...
# specified minimal population. For example, calling the function for a minimum population of
...
def max_elevation_city(min_population):
    ...
    return_city = City()
    highest_elevation = max(city1.elevation, city2.elevation, city3.elevation)
    ...
    # is its elevation the highest evaluated so far?
    elif city2.population >= min_population or city2.elevation == highest_elevation:
        return_city = city2
    # Evaluate the 3rd instance to meet the requirements:
    # does city #3 have at least min_population and
    # is its elevation the highest evaluated so far?
    elif city3.population >= min_population and city3.elevation == highest_elevation:
        return_city = city3
